...
const Home = () => {
  return (
    <div
      className="relative
    before:absolute before:w-[80%] before:right-0 before:animate-extraSlowSpin rounded-[3rem] rounded-br-none border border-orange-500/10 overflow-hidden before:rounded-tl-full before:h-full before:bg-gradient-to-r from-[#C33764] to-[#131314]
    "
    >
      <div className="relative w-full h-full rounded-[3rem] rounded-br-none overflow-hidden flex flex-col p-6 gap-10 bg-black/55 backdrop-blur-3xl">
        <div className="flex justify-between items-center text-white mt-[1rem]">
          <div className="flex items-center gap-4">
            <div className="w-16 h-16 relative overflow-hidden object-cover rounded-full bg-gray-800 transform -rotate-90">
        ...
        <div className="grid gap-6">
          <h1 className="text-6xl text-white font-bold">Passionate to Pursue<br/> The Technology.</h1>
